...
public partial class Store_HarveyNorman : System.Web.UI.Page
{
    ...
    protected void sendBlogBtn_Click(object sender, EventArgs e)
    {
        ...
        if (charsLeft >= 0)
        {
            ...
            BlogReaderWriter blogWriter = new BlogReaderWriter(Path.GetFullPath(Server.MapPath("~\\files\\HarveyNormanUserEntry.txt")));
            ...
            blogWriter.writeBlogToEntryFile("HarveyNorman", (String)Session["loginID"], unixTimestamp.ToString(), newBlogTextBox.Text);
    ...
    private void getNextFiveBlogsFromList()
    {
        ...
        BlogReaderWriter blogReader = new BlogReaderWriter(Path.GetFullPath(Server.MapPath("~\\files\\HarveyNormanUserEntry.txt")));
